...
const MainLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* header */}
      <div className="fixed top-0 left-0 w-full h-16 z-20 bg-white">
      ...
      {/* button navigation */}
      <div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border-t border-gray-200 bottom-0 left-1/2 dark:bg-gray-700 dark:border-gray-600">
